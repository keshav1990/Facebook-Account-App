...
function register()
 @Description:- This function is used to register new account.
 */ 
...
/* @Description:- This function is create to login user with valid account   */
		public function loginAccount()
		{
			...
			$this->form_validation->set_rules('password','password', 'trim|required');
				/* this condition is used to check the form validation *//* this condition is used to check the form validation */
