<div class="page-content-wrapper">
                ...
                <div class="page-content" style="min-height: 1434px;">
                    <!-- BEGIN PAGE HEADER-->
                      ...
                      <h1 class="page-title">Auction Setting </h1>
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            <li>
                                <i class="fa fa-cog"></i>
                                <a href="">Auction Setting</a>
						...
						<?php } ?>
                                ...
                                <div class="portlet-title">
                                    <div class="caption font-red-sunglo">
                                        ...
                                        <span class="caption-subject bold uppercase"> Auction Setting</span>
                                    </div>
                                 </div>
										   ...
										   <?php $new_passwordError = strip_tags( form_error('newpassword')); ?>
                                            <div class="form-group  col-md-6 <?php if($new_passwordError){ ?> has-error <?php }?>">
												...
												<?php $confirm_passwordError = strip_tags( form_error('confirmpassword')); ?>
												 <div class="form-group  col-md-6 <?php if($confirm_passwordError){ ?> has-error <?php }?>">
