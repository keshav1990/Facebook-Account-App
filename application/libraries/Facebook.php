...
require_once APPPATH.'/third_party/php-graph-sdk/autoload.php';
...
Class Facebook
{
    ...
    /*
    @Return facebook app variable
    */
    public function app_object(){
      $fbApp = new Facebook\FacebookApp($this->config->item('facebook_app_id'), $this->config->item('facebook_app_secret'));
     return $fbApp;
    }
    /**
